            ...
            <div class="col-lg-7">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('kontakuserr') }}" method="post" class="needs-validation" novalidate data-aos="fade-up" data-aos-delay="200">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="subjek" id="subjek" value="{{ old('subjek') }}" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12 text-center pt-5 my-5">
                                    <button type="submit" class="btn rounded-pill py-2 px-4" style="background-color: #87CEEB; color: white; border: none;">Kirim Pesan</button>
                                </div>
                            </div>
                        </form>
                    </div>
